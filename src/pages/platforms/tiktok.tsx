      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-6xl rounded-xl border border-primary/10 bg-card/40 p-6 md:p-8 shadow-lg backdrop-blur text-foreground">
          ...
          <div className="section-block section-legal mb-8 md:mb-10">
            ...
            <p className="section-muted mb-4">
              Downloading TikTok videos sits in a gray spot, depending on how you use them. <a href="https://support.tiktok.com/en/using-tiktok/exploring-videos/video-downloads">TikTok's rules let you save public clips for offline viewing</a>, as long as the creator didn't block it. That's fine for your eyes only, like stashing a funny pet vid. But their terms ban third-party tools, so using sites like ours could flag your account if they spot patterns. Still, millions do it without issues, as enforcement focuses on big re-uploads.
            </p>
            <p className="section-muted mb-4">

    ...
    <div className="min-h-screen relative">
      <div className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-5xl rounded-xl border border-primary/10 bg-card/40 p-6 md:p-8 shadow-lg backdrop-blur text-foreground">
          ...
          {/* Why Download */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">Why Download YouTube Videos</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">Top Use Cases for Offline Video Access</h2>
          ...
          <p className="text-muted-foreground mb-8">Downloading YouTube videos offers flexibility and convenience, making it easier to enjoy content on your terms, whether for fun, work, or learning.</p>

          {/* Who Should Download */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">Who Should Download YouTube Videos</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">People Who Benefit Most from Offline Videos</h2>
          <p className="text-muted-foreground mb-4">Downloading YouTube videos isn’t just for casual viewers—it’s a game‑changer for specific groups who need offline access for work, creativity, or convenience. Here’s a look at who can get the most out of downloading YouTube videos and why it’s worth doing.</p>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
          ...
          <p className="text-muted-foreground mb-8">No matter your role or lifestyle, downloading YouTube videos can save time, data, and effort while keeping your favorite content accessible.</p>

          {/* Legal */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">Is It Legal to Download YouTube Videos?</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">What You Need to Know About the Law</h2>
          ...
          <p className="text-muted-foreground mb-2">However, there are exceptions where downloading may be legal:</p>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
          ...
          <p className="text-muted-foreground mb-8">To stay safe, check the video’s license in its description or contact the creator for permission. YouTube Premium offers a legal way to save videos offline for personal use. If you’re unsure, err on the side of caution to respect creators and avoid violating copyright laws.</p>

          {/* Risks */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">Risks of Downloading YouTube Videos</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">Potential Dangers and How to Avoid Them</h2>
          <p className="text-muted-foreground mb-4">While downloading YouTube videos is convenient, it comes with risks if you use the wrong tools or ignore legal boundaries. Being aware of these dangers helps you make smart choices and protect your device and data. Here are the main risks to watch out for.</p>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
          ...
          <p className="text-muted-foreground mb-8">By using a trusted, secure tool like videodownload.io and respecting copyright rules, you can minimize these risks and enjoy safe, reliable downloads.</p>

          {/* Why Use videodownload.io */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">Why Use videodownload.io</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">Your Trusted Partner for YouTube Downloads</h2>
          ...
          {/* FAQs */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">FAQs</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">Common Questions About videodownload.io and YouTube Downloads</h2>
          <p className="text-muted-foreground mb-4">We’ve compiled answers to the most frequent questions about using videodownload.io and downloading YouTube videos to help you get started with confidence.</p>
          <div className="space-y-4 text-muted-foreground mb-8">
            <p><strong>1. Is videodownload.io really free to use?</strong> Yes, our platform is 100% free. You can download as many videos as you want without any charges or limits.</p>
            <p><strong>2. Do I need to install software to download videos?</strong> No, videodownload.io works entirely through your web browser. No apps, extensions, or downloads are needed, keeping things simple.</p>
            <p><strong>3. Can I download entire YouTube playlists?</strong> Absolutely. Just paste the playlist URL, and our system will process all videos in the playlist for you to download at once.</p>
            <p><strong>4. Is it safe to use videodownload.io?</strong> Yes, our site is secure, with no pop-up ads or malicious links. We prioritize user safety and test our platform to keep it clean and reliable.</p>
            <p><strong>5. Can I download videos in high quality, like 4K?</strong> If the YouTube video is available in 4K, you can download it in that resolution. We support a range of qualities, from 360p to 4K, depending on the source.</p>
            <p><strong>6. What if a video doesn’t download properly?</strong> Double-check the URL and your internet connection. If the issue persists, reach out to our support team, and we’ll troubleshoot the problem for you.</p>
            <p><strong>7. Can I extract audio from YouTube videos?</strong> Yes, our MP3 conversion feature lets you download just the audio from any YouTube video, perfect for music or podcast clips.</p>
            <p><strong>8. Is downloading YouTube videos legal?</strong> It depends on the video. YouTube’s Terms of Service ban downloading unless permitted, but videos in the public domain, under Creative Commons, or with creator approval are often fine. Fair use may apply for things like education or commentary, but always verify the video’s license to avoid issues.</p>
          </div>

          {/* Start Downloading Now */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent">Start Downloading Now</h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white">Get Your YouTube Videos in Seconds</h2>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-2">
            <li>Fast and simple process</li>
            <li>Safe, malware-free downloads</li>
            <li>High-quality video and audio options</li>
          </ul>
          <p className="text-primary font-semibold">Download Your Video</p>
        </div>
      </div>
    </div>
  );
